...
- [ ] **I. Simplicity (YAGNI)**: Simplest design that works; no speculative abstraction/config (justify any complexity below)
- [ ] **II. Test-First**: Tests planned to accompany code; `make test` gating defined
- [ ] **III. Modular Boundaries**: Reusable logic lives in `pkg/*`; `cmd/` stays a thin shell
- [ ] **IV. Issue-Tracked Workflow**: Epic created with `sl issue create --type epic` and linked to spec; conventional commits
- [ ] **V. Observability by Default**: Logging/health/error-surface strategy documented for anything that runs unattended
