...
description: >-
  ...
  text, error message, or output format in a Go CLI — including the `sheesh` CLI in this repo.
...
[Cobra](https://github.com/spf13/cobra) CLIs (such as the `sheesh` CLI in this repo).
